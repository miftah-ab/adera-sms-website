...
export default function TrustPrivacy() {
  ...
  return (
    <section id="privacy" className="relative bg-[#07130b] py-24 lg:py-32 border-t border-white/[0.06] overflow-hidden">
      {/* Glow accent */}
      <div className="absolute top-1/3 right-10 h-[450px] w-[450px] rounded-full bg-emerald-500/[0.06] blur-[140px] pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-3">
          ...
          <div className="rounded-3xl border border-white/[0.08] bg-[#0c2015] p-7 shadow-lg">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-500/20 text-emerald-400">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
            </div>
            <h3 className="mt-5 text-lg font-bold text-white">100% Local Processing</h3>
          ...
          <div className="rounded-3xl border border-white/[0.08] bg-[#0c2015] p-7 shadow-lg">
            ...
            <h3 className="mt-5 text-lg font-bold text-white">No Ads, No Selling Data</h3>
            <p className="mt-2 text-sm text-zinc-400 leading-relaxed">
          ...
          <div className="rounded-3xl border border-white/[0.08] bg-[#0c2015] p-7 shadow-lg">
            ...
            <h3 className="mt-5 text-lg font-bold text-white">Transparent Telemetry</h3>
            <p className="mt-2 text-sm text-zinc-400 leading-relaxed">
        ...
        <div className="mt-12 rounded-3xl border border-white/[0.08] bg-[#091710] p-6 sm:p-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/[0.08] pb-5">
            <div>
              <h3 className="text-lg font-bold text-white">Android Permissions Explained</h3>
            ...
            {permissions.map((perm) => (
              <div key={perm.name} className="py-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div className="flex items-center gap-2.5">
                  <code className="text-xs font-mono font-semibold text-emerald-300 bg-emerald-950/60 border border-emerald-500/20 px-2 py-1 rounded">
                    {perm.name}
                  </code>
                </div>
                <p className="text-xs text-zinc-300 flex-1 sm:px-6">
                  {perm.purpose}
                </p>
                <span className="self-start sm:self-auto text-[10px] font-bold uppercase tracking-wider text-emerald-400 bg-emerald-500/10 px-2.5 py-0.5 rounded-full border border-emerald-500/20">
                  Local Only
                </span>
              </div>
            ))}
