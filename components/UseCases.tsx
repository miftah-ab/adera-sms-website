export default function UseCases() {
  ...
  return (
    <section className="relative bg-[#050b08] py-24 lg:py-32 border-t border-white/[0.06] overflow-hidden">
      <div className="relative z-10 mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {useCases.map((uc) => (
            <div
              key={uc.title}
              className="group rounded-3xl border border-white/[0.08] bg-[#091710] p-7 transition-all duration-300 hover:border-emerald-500/30 hover:bg-[#0c2016] hover:-translate-y-1 shadow-lg"
            >
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-emerald-500/10 border border-emerald-500/20 group-hover:bg-emerald-500/20 transition-colors">
                {uc.icon}
              </div>
