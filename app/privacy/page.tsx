      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-10 space-y-10 text-sm leading-relaxed text-zinc-300">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-white">3. Information Adera SMS May Access</h2>
            
            <div className="space-y-2">
              <h3 className="text-base font-bold text-emerald-400">3.1 Phone/Call State Information</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="text-base font-bold text-emerald-400">3.2 Missed-Call Information</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="text-base font-bold text-emerald-400">3.3 Call-Log Information</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="text-base font-bold text-emerald-400">3.4 Phone Number Information</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="text-base font-bold text-emerald-400">3.5 SMS-Related Information</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="text-base font-bold text-emerald-400">3.6 Device/Application Information</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="text-base font-bold text-emerald-400">3.7 Information Provided Voluntarily by the User</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="text-base font-bold text-emerald-400">3.8 Information Generated Through Use of the Application</h3>
              <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">4. Android Permissions</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">5. How Adera SMS Uses Information</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">6. Automated SMS</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">7. Local Processing and Data Storage</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">8. Data Sharing and Disclosure</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">9. Data Retention</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">10. Data Deletion</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">11. User Rights</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">13. International Users</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">14. GDPR-Related Information</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">16. Third-Party Services and Links</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">17. Changes to This Privacy Policy</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">18. Contact</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">19. Legal Disclaimer</h2>
            <p>
          ...
          <section className="space-y-3 rounded-2xl border border-emerald-500/30 bg-emerald-950/20 p-6">
            <h2 className="text-xl font-bold text-emerald-300">20. Privacy at a Glance</h2>
