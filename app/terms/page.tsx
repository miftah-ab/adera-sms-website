  ...
  return (
    <div className="min-h-screen bg-white text-slate-700">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-10 space-y-9 text-sm leading-relaxed text-slate-600">
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">1. Introduction and Acceptance</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">3. Eligibility</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">4. License to Use Adera SMS</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">5. Permitted Use</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">6. Prohibited Use</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">7. User Responsibilities</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">8. User-Configured Automated SMS</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">9. SMS Sending and Carrier Charges</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">10. Consent and Respect for Recipients</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">11. Spam, Harassment, Abuse, Fraud, and Illegal Communications</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">12. Misuse of Automated Messaging</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">13. Device and Permission Requirements</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">14. Third-Party Networks and Services</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">15. Availability of the Application</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">16. Updates and Changes to the Application</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">17. Beta/Experimental Features</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">18. Intellectual Property</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">19. User Content and Message Templates</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">20. Feedback</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">21. Privacy</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">22. Third-Party Services</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">23. Disclaimers</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">24. Limitation of Liability</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">25. Indemnification</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">26. Suspension or Termination</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">27. Effect of Termination</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">28. Changes to These Terms</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">29. Governing Law</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">30. Dispute Resolution</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">31. Severability</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">32. Waiver</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">33. Entire Agreement</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">34. Assignment</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">35. Force Majeure</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">36. Notices</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">37. Contact Information</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">38. Effective Date / Last Updated</h2>
            <p>
